...
#define DSCSERIALIZE_COMPACT_BUFSIZE_hello_world	256

_WINDLL_FUNC int DSCSERIALIZE_COMPACT_hello_world( hello_world *pst , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_COMPACT_hello_world( char *buf , int *p_len , hello_world *pst );
